...
class HomeDetailPage extends StatefulWidget {
  final String title;
  const HomeDetailPage({super.key, required this.title});
...
class _HomeDetailPageState extends State<HomeDetailPage> {
  ...
  void loadData() async {
    if(widget.title == "Mới nhất")
      result = await PostAPI().getPosts(page: page);
    else if(widget.title == "TP. Hồ Chí Minh"){
      result = await PostAPI().getPosts(page: page,city: "Thành phố Hồ Chí Minh");
      setState(() {
        cityName = "Thành phố Hồ Chí Minh";
      });
    }
    else if(widget.title == "Hà Nội"){
      result = await PostAPI().getPosts(page: page,city: "Thành phố Hà Nội");
      setState(() {
